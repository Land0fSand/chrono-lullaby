...
function Get-LatestLogFiles {
    $processInfoPath = "process_info.json"
...
if (-not $Follow) {
    ...
    Write-Host "  ./logs.ps1 -Type downloader -Follow    # 实时查看下载器日志" -ForegroundColor Gray
    Write-Host "  ./logs.ps1 -List                       # 列出所有日志" -ForegroundColor Gray
} 